...
export default function AppShell({
  ...
  const [open, setOpen] = useState({ inventory: true, t4: false, liftings: false });
    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <SidebarSection label="T4 Receipts" open={open.t4} onToggle={() => toggle('t4')}>
            <T4PasteInput terminalConfig={terminalConfig} onReceiptsChange={setReceipts} />
          </SidebarSection>

          <SidebarSection label="Rack Liftings" open={open.liftings} onToggle={() => toggle('liftings')}>
            <LiftingsInput
              terminalConfig={terminalConfig}
              liftings={liftings}
        ...
        <div style={{ flex: 1, overflowY: 'auto', backgroundColor: C.pageBg }}>
          ...
          {/* Blend Plan Summary — collapsible, full-width, below grid */}
